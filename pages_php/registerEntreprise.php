<?php
        ...
        if(isset($_POST['sendFormRegister'])){
                ...
                if (strlen($businessName) <= 255 AND strlen($siretNumber) <= 255 AND strlen($email) <= 255 AND strlen($address) <= 255 AND strlen($city) <= 255 AND strlen($country) <= 255 AND strlen($password) <= 255 AND strlen($activity) <= 255) {
