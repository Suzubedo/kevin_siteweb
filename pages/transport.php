<?php 
	...
	$req->execute(array($city, $transport));
	?>
	
	<h3>Listes des transports à <?php echo $city; ?></h3>
	<?php
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <form method="POST" action="../pages_php/transport.php?city=<?php echo $city;?>">
		        	<div class="form-row">
			         <div class="col-md-6 mb-3">
			            <input type="hidden" class="form-control" id="validationDefault01" name="id_client" value=<?php echo $_SESSION['id'];?>>
			         </div>
			         <div class="col-md-6 mb-3">
			            <input type="hidden" class="form-control" id="validationDefault02" name="id_service" value=<?php echo $resultat['id'];?> >
			         </div>
			        </div>
			        <div class="form-row">
			         <div class="col-md-6 mb-3">
